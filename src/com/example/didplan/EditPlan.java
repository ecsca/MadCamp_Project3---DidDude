...
public class EditPlan extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		switch (v.getId()) 
		{
			case R.id.writePlan:
				...
				String q = "UPDATE '"+year+"."+month+"' set content = '"+strCont + "' where hour = "+hour + " and day = "+day + " ;";
				database.execSQL(q);
				q = "UPDATE '"+year+"."+month+"' set title = '"+strTitle + "' where hour = "+hour + " and day = "+day + " ;";
				database.execSQL(q);
				finish();
				break;
