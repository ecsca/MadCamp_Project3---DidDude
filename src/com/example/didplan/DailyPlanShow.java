...
public class DailyPlanShow extends FragmentActivity {

	private Context mContext = null;
	final String databaseName = "DidDude.db";
	private SQLiteDatabase database = null;
	private ArrayList<DailyCell> dayCell;
	private DailyShowAdapter mDailyAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dailyshow);
		mContext = this;
		...
		do {
			...
			if (c.getString(6) != null) {
				...
				dayCell.add(new DailyCell(String.valueOf(c.getInt(0)), String
						...
						String.valueOf(c.getDouble(3)), c.getString(6), c.getString(7)));
			}
		} while (c.moveToNext());
		initDailyAdapter();

		/*
		 * Log.e("qqqq", "1"); String squery ="SELECT * FROM " + "'" + year +
		 * "." + month + "'"; Log.e("qqqq", squery); Cursor c =
		 * database.rawQuery(squery, null); Log.e("qqqq", "2"); c.moveToFirst();
		 * int d, h; do { Log.e("qqqq", c.getInt(0)+""+c.getInt(1) +""+
	...
	void calleditList() {
		Intent dayIntent = new Intent(mContext, Daily.class);
	...
	private void initDailyAdapter() {
		mDailyAdapter = new DailyShowAdapter(this, R.layout.hour, dayCell,
				year, month);
