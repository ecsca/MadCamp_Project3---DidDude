...
public class DailyPlan extends FragmentActivity {

	private Context mContext = null;
	final String databaseName = "DidDude.db";
	private SQLiteDatabase database = null;
	private ArrayList<DailyCell> dayCell;
	private DailyPlanAdapter mDailyAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dailyplan);
		mContext = this;
	...
	private void initDailyAdapter() {
		mDailyAdapter = new DailyPlanAdapter(this, R.layout.hourplan, dayCell, year,month);
