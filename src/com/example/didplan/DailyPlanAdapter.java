...
public class DailyPlanAdapter extends BaseAdapter{
	...
	public DailyPlanAdapter(Context context, int textResource, ArrayList<DailyCell> daycell, String year, String month)
	{
	...
	{
		Intent editor = new Intent(mContext, EditPlanplan.class);
	...
	public class mListener implements OnClickListener
	{
		...
		DailyPlanAdapter ad;
		public mListener(int pos, ArrayList<DailyCell> dayCell, DailyPlanAdapter ad)
		{
			this.pos= pos;
			this.dayCell = dayCell;
			this.ad = ad;
	...
	public class locListener implements OnClickListener
	{
		...
		ArrayList<DailyCell> dayCell;
		DailyPlanAdapter ad;
		public locListener(int pos, ArrayList<DailyCell> dayCell, DailyPlanAdapter ad)
		{
			this.pos= pos;
			this.dayCell = dayCell;
			this.ad = ad;
